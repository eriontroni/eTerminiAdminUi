...
const emptyForm = { categoryId: '', name: '', description: '', durationMinutes: 30 }
...
export default function ServiceCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError(null)
    try {
      await createService({ ...form, departmentId, durationMinutes: Number(form.durationMinutes) })
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Shto Shërbim</h1>
          <p className="text-slate-500 text-sm">Plotëso të dhënat e shërbimit të ri</p>
        </div>
      </div>
