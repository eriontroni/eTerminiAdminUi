...
export default function DepartmentCreate() {
  ...
  const { create }           = useDepartments(institutionId)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast('Departamenti u krijua me sukses!')
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Shto Departament</h1>
          <p className="text-slate-500 text-sm">Plotëso të dhënat e departamentit të ri</p>
        </div>
      </div>
